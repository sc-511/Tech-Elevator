...
// LECTURE STARTS HERE ---------------------------------------------------------------
// you want all of the code to load together asynch with each other. Allows your application to be completed together
document.addEventListener("DOMContentLoaded", () => {
  ...
  const addReviewButton = document.querySelector("#btnToggleForm");
